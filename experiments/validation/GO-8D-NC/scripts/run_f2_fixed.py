# F2 Execution Script - GO-8D-NC (Fixed)
...
from pilot_engine import run_study, cell, dv3
from seeds_nc import seeds

# BIP directories - two locations with actual directory names
...
# Actual BIP directory names in GO-8C
GO8C_BIPS = [
...
# BIP directories in GO-8D-NC (standard format BIP-013 through BIP-030)
GO8D_BIPS = [f"BIP-{i:03d}" for i in range(13, 31)]  # 013-030

print("=" * 60)
print("F2 EXECUTION - GO-8D-NC (Fixed)")
print("=" * 60)

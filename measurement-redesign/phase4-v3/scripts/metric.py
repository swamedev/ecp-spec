...
Lê outputs/reconstruction_graphs.json e computa, por caso × estado:
  ...
  dv_p      = DV_REDESIGN decisório (§7.1 v3) = 0.6·conf + 0.2·ged_ref + 0.2·div_metric.
  dv_q      = DV_REDESIGN diagnóstico (§7.1 v3) = 0.7·conf + 0.3·div_metric (sem ged_ref).
